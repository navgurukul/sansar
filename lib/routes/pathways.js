  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        const data = await pathwayService.findById(pathwayId);
        const result = Object.assign({}, data[1], request.payload);
        ...
        const updateAndFetch = async (txn) => {
          ...
          // return [null, await pathwayService.findById(pathwayId, txn)];
          return await pathwayService.findById(pathwayId, txn)
        };
